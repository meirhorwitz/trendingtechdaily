...
const { handleArticleRouting, handleLegacyRedirects } = require('./http/routing');
...
exports.suggestArticleTopic = onCall({ secrets: ["GEMINI_API_KEY"], region: 'us-central1' }, aiCallables.suggestArticleTopic);
